...
async function askForResourceType() {
  ...
  //         disabled:
  //           orm === null
  //             ? "[You need to have an orm installed. Run 'Saasmd add']"
  //             : false,
  //       },
  ...
  //           ? "[You need to have trpc installed. Run 'Saasmd add']"
  //           : false,
  //       },
  //       {
  ...
  //             ? "[You need to have shadcn-ui and trpc installed. Run 'Saasmd add']"
  //             : false,
  //       },
  //       {
  //         name: "Server Actions",
    ...
    choices: [
      ...
      { name: "Controller", value: "controller" },
      {
        ...
        disabled: !packages.includes("shadcn-ui")
          ? "[You need to have shadcn-ui installed. Run 'saasmd add']"
          : false,
      },
    ],
  })) as TResourceGroup[];
