...
export const showNextSteps = (
  ...
  const nextStepsFormatted = `🚀 Thanks for using SaasMD to kickstart your Next.js app!
...
Hint: use \`saasmd generate\` to quickly scaffold entire entities for your application`;
